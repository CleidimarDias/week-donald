...
-- CreateEnum
CREATE TYPE "ComsunptiomMethod" AS ENUM ('TAKEAWAY', 'DINE_IN');
...
CREATE TABLE "Order" (
    ...
    "consumptionMethod" "ComsunptiomMethod" NOT NULL,
...
-- AddForeignKey
ALTER TABLE "MenuCategory" ADD CONSTRAINT "MenuCategory_restauranteId_fkey" FOREIGN KEY ("restauranteId") REFERENCES "Restaurante"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Product" ADD CONSTRAINT "Product_restauranteId_fkey" FOREIGN KEY ("restauranteId") REFERENCES "Restaurante"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
